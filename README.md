...
2. Recall: Measures the proportion of true positives among actual positives.
...
3. Precision: Indicates the proportion of true positives among predicted positives.
